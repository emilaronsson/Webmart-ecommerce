...
const ProductDetails = () => {
    ...
    const { imgUrl, price, productName, description, shortDesc, avgRating, reviews } = product;
...

                            {
                                ...
                                <div className='product__review mt-5'>
                                    <div className='review__wrapper'>
                                        <ul>
                                            {
                                                reviews?.map((item, index) => (
                                                    <li key={index} className='mb-4'>
                                                        <h6>Mr. Reviewer</h6>
                                                        <span>{item.rating} <i class="ri-star-s-fill"></i></span>
                                                        <p>{item.text}</p>
                                                    </li>
                                                ))
                                            }
                                        ...
                                        <h4>Tell us about your experience with this product</h4>
                                            <form action=''>
